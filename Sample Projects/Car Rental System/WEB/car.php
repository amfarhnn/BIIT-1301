...
<td ><?php echo $row['carID']; $carID= $row['carID'];;?></td>
<td ><?php echo $row['carName'];?></td>
<td ><?php echo $row['carBrand'];?></td>
<td><?php echo $row['carType'];?></td>
<td ><?php echo $row['carCapacity'];?></td>
<td ><?php echo $row['carColour'];?></td>
<td ><?php echo $row['carPlate'];?></td>
<td ><?php echo $row['carYear'];?></td>
<td ><?php echo $row['carPrice'];?></td>
<td ><?php echo $row['carStatus'];?></td>
<td ><?php echo $row['carNotes'];?></td>
<td ><?php $res=mysqli_query($conn,"SELECT count(*) as total from booking WHERE carID='$carID'");
...
<td> <a href="deleteCar.php?carID=<?php echo $row['carID'];?>" class ="btn btn-danger" name="submit" >Delete</button></td>
<td> <a href="updateC.php?carID=<?php echo $row['carID'];?>" class ="btn btn-success"   >update</a></td>
